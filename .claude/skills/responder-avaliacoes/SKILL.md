...
description: >
  Escreve resposta curta e humana pra avaliação de cliente no Google, uma por uma, sem cara
  de resposta automática de empresa grande.
  Use quando a pessoa disser "responder avaliação", "resposta pro Google", "tem avaliação
  nova", "me ajuda a responder esses clientes", "um cliente me avaliou", "cliente reclamou
  no Google", "levei uma avaliação ruim", "o que eu respondo pra ele", "avaliação do GMB",
  "responde essas reviews", ou colar o texto ou o print de uma avaliação.
---
...
| 3★ ou menos | **Escrever uma proposta de resposta e conferir antes de entregar como final.** Avaliação ruim é a única que merece uma pergunta: "O que aconteceu nesse caso? Escrevi uma resposta aqui, mas se você me contar o lado de vocês eu deixo ela certa." Nunca responder cliente insatisfeito no automático, e nunca entregar sem ele ler antes |
