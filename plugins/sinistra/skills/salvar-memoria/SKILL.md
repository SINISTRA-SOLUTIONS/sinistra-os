...
- Nunca gravar regra de negócio, preferência ou informação da empresa dentro de
  `${CLAUDE_PLUGIN_ROOT}`. Aquilo é o sistema da Sinistra, é trocado inteiro na próxima
  atualização, e o que for gravado lá se perde. Tudo do negócio mora na pasta do cliente
